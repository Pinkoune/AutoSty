...
pitLogRY1 = customtkinter.IntVar(root)
...
def RY1():
    ...
    pit = customtkinter.CTkRadioButton(master=frame, text="en PIT", variable=pitLogRY1, value=0)
    pit.pack(pady=12, padx=10)

    log = customtkinter.CTkRadioButton(master=frame, text="en LOG", variable=pitLogRY1, value=1)
