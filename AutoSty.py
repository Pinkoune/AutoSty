...
def BousePos():
    pyautogui.click(877,404, duration=0.1, button="right")
    pyautogui.moveTo(1050,525, duration=0.1)
    time.sleep(1.5)
    pyautogui.click(1380,660, duration=0.1)
    time.sleep(1.5)
    pyautogui.click(345,750, duration=0.3)
    pyautogui.click(345,750, duration=0)
